...
export default function Footer({ isDestructive }: FooterProps) {
  ...
  return (
    ...
    >
      <div
        className={`relative aircraft-panel hud-grid w-[90vw] max-w-6xl px-12 py-6 backdrop-blur-md transition-all duration-700 ${
          isDestructive ? "warning" : ""
        } bg-black/60`}
        style={{
          
          clipPath: isDestructive
          ...
          boxShadow: isDestructive
            ? "0 0 30px rgba(255, 100, 0, 0.3), inset 0 0 20px rgba(255, 100, 0, 0.2)"
      ...
      >
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-3 pt-6 md:pt-8">
            <h3
              className={`text-2xl font-bold font-mono tracking-widest aircraft-text ${
                isDestructive ? "warning" : ""
              }`}
            >
              OJASS '26
            ...
            <p
              className={`text-xs font-mono tracking-wide aircraft-text ${
                isDestructive ? "warning" : ""
              } opacity-90`}
            >
            ...
            <div
              className={`text-xs font-mono aircraft-text ${
                isDestructive ? "warning" : ""
              } opacity-75`}
            >
          ...
          <div className="space-y-3">
            <h3
              className={`text-lg font-bold font-mono tracking-widest aircraft-text ${
                isDestructive ? "warning" : ""
              }`}
            >
              NAVIGATION
            ...
            <div className="space-y-2">
              {["EVENTS", "WORKSHOPS", "SPONSORS", "TEAM"].map((link) => (
                <div
                  key={link}
                  className={`text-xs font-mono tracking-wider aircraft-text cursor-pointer hover:scale-105 transition-transform ${
                    isDestructive ? "warning" : ""
        ...
        <div
          className={`pt-4 border-t transition-all duration-700 ease-out mt-6 ${
            isDestructive ? "border-orange-500/30" : "border-cyan-500/30"
          }`}
        >
          <div
            className={`text-center text-[10px] font-mono tracking-widest aircraft-text ${
              isDestructive ? "warning" : ""
